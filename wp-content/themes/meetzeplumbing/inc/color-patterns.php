<?php
/**
 * Meetze Plumbing: Color Patterns
 *
 * @package WordPress
 ...
 */
function meetzeplumbing_custom_colors_css() {
	...
	/**
	 * Filter Meetze Plumbing default saturation level.
	 *
	 * @since Meetze Plumbing 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = meetzeplumbing_get_default_saturation();
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Meetze Plumbing default selection saturation level.
	 *
	 * @since Meetze Plumbing 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = meetzeplumbing_get_default_saturation_selection();
	$saturation_selection = absint( $saturation_selection ) . '%';

	/**
	 * Filter Meetze Plumbing default lightness level.
	 *
	 * @since Meetze Plumbing 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = meetzeplumbing_get_default_lightness();
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Meetze Plumbing default hover lightness level.
	 *
	 * @since Meetze Plumbing 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = meetzeplumbing_get_default_lightness_hover();
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Meetze Plumbing default selection lightness level.
	 *
	 * @since Meetze Plumbing 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = meetzeplumbing_get_default_lightness_selection();
	...
	/**
	 * Filters Meetze Plumbing custom colors CSS.
	 *
	 * @since Meetze Plumbing 1.0
	 *
	 ...
	 */
	return apply_filters( 'meetzeplumbing_custom_colors_css', $theme_css, $primary_color, $saturation );
}
